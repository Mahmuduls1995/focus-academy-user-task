...
import signUpBackground from '../../assets/images/loginbackground.jpg'
const SignUp = () => {
            ...
            <div className="card w-96  bg-gray-300 shadow-xl">
                <div className="card-body">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="form-control my-3 bg-gray-300 w-full max-w-xs">
                            <label className="label">
                        ...
                        {signInError}
                        <input className='btn w-full bg-primary mt-2 max-w-xs text-white' type="submit" value="Sign Up" />
                    </form>
